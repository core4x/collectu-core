"""
The both defined lists (x_key and y_key) need the same length and consist only of entries of the data type int or float.
"""
...
class ProcessorModule(AbstractProcessorModule):
    ...
    description: str = "This module creates a x/y plot on the dashboard."
    """A short description."""
