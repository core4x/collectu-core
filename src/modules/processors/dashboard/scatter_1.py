"""
Only values of data type number (int or float) are taken.
"""
...
class ProcessorModule(AbstractProcessorModule):
    ...
    description: str = "This module creates a scatter plot on the dashboard."
    """A short description."""
    ...
    def _run(self, data: models.Data) -> models.Data:
        ...
        """
        # TODO: Here we could check if the data fits to the previous one (--> int or float).
