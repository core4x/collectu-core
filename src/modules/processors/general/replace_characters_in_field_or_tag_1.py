...
class ProcessorModule(AbstractProcessorModule):
    ...
    description: str = "This module replaces characters in field or tag keys."
    """A short description."""
    ...
    def _run(self, data: models.Data) -> models.Data:
        ...
        if key != "*":
            if data.fields.get(key, None) is not None:
                new_key = key.replace(self.configuration.old, self.configuration.new)
                if new_key != key:
