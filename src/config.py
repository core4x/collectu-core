...
USAGE_STATISTICS_RECEIVER: str = os.getenv("USAGE_STATISTICS_RECEIVER", "https://api.collectu.de/api/v1/statistic")
...
HUB_MODULES_ADDRESS: str = os.getenv("HUB_MODULES_ADDRESS", "https://api.collectu.de/api/v1/module")
"""The endpoint of the api for registering modules."""

HUB_CONFIGURATIONS_ADDRESS: str = os.getenv("HUB_CONFIGURATIONS_ADDRESS", "https://api.collectu.de/api/v1/configuration")
"""The endpoint of the api for registering configurations."""

HUB_APP_ADDRESS: str = os.getenv("HUB_APP_ADDRESS", "https://api.collectu.de/api/v1/app")
"""The endpoint of the api for reporting app data. Used in utils.mothership_interface."""

HUB_GET_APP_ADDRESS: str = os.getenv("HUB_GET_APP_ADDRESS", "https://api.collectu.de/api/v1/app/app_id")
"""The endpoint of the api for getting app data. Used for api authentication."""

HUB_TASK_ADDRESS: str = os.getenv("HUB_TASK_ADDRESS", "https://api.collectu.de/api/v1/task/app_id")
"""The endpoint of the api for requesting tasks. Used in utils.mothership_interface."""

HUB_TEST_TOKEN_ADDRESS: str = os.getenv("HUB_TEST_TOKEN_ADDRESS", "https://api.collectu.de/api/v1/login/test-token")
"""The endpoint of the api for testing the api access token."""

HUB_LOGIN_ADDRESS: str = os.getenv("HUB_LOGIN_ADDRESS", "https://api.collectu.de/api/v1/login/access-token")
